...
export default function SingleChat({fetchAgain,setFetchAgain}) {
    ...
    },[]);//should be at the top of other useEffect's so that socket gets initialized first.
    ...
    const sendMessage = async function(event) {
        if(event.key === "Enter" && newMessage){
            ...
            try{
                ...
                setNewMessage("");//added here, just to make sure that input field instantly gets empty. Doesn't effect below API call since this is asynchronous operation.
    ...
    const typingHandler = function(event) {
